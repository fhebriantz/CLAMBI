                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <div class="p-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="id_so"  autocomplete="off" required  value="{{$order->id_so}}"  type="number" placeholder="Masukan Stok" name" class="form-control" id="id_so">
                                                </div>
                                        ...
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            <div class="p-20">
                                                ...
                                                <div class="form-group text-right m-b-0">
                                                    <button class="btn btn-primary waves-light" style="width: 100%" type="submit" onclick="return confirm('Are you sure?');">
                                                        Tambah Barang
                                                    </button>
                                                </div>
                                                </form>
