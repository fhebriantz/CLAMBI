                ...
                <div class="content">
                    <div class="container">
                        ...
                        <!-- end row -->
                                            ...
                                            @if($laundry->id_promo == 0)
                                            <?php $harga_akhir = $laundry->total_payment;?>
                                            @else
                                            <?php if ($promo->type == 'potongan_harga'): ?>
                                            <?php $harga_akhir = $laundry->total_payment - $promo->nominal;?>
                                            <?php elseif ($promo->type == 'diskon'): ?>
                                            <?php $harga_akhir = $laundry->total_payment - ($laundry->total_payment * $promo->nominal)/100;?>
                                            <?php else: ?>
                                            <?php $harga_akhir = $laundry->total_payment;?>
                                            <?php endif ?>
                                            @endif
                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <div class="col-sm-6 test">
                                            ...
                                            <p>@if($laundry->id_promo == 0)-@else{{$promo->promo_code}}@endif</p>
                                            

                                            <label for="">Promo</label>
                                            <p>@if($laundry->id_promo == 0)-@else{{$promo->promo_name}}@endif</p>

                                            <label for="">Tipe Promo</label>
                                            <p>@if($laundry->id_promo == 0)-@else{{$promo->type}}@endif</p>

                                            <label for="">Nominal</label>
                                            <p>@if($laundry->id_promo == 0)-@else{{$promo->nominal}}@endif</p>
